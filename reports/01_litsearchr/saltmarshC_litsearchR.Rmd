...
scopus_final  <- 
    import_results(
    directory = "/home/lukas/Desktop/SaltmarshC/reports/01_litsearchr/final_refs/scopus", #absolute path
    verbose = TRUE
  )
...
alongi_refs  <- 
    import_results(
    directory = "/home/lukas/Desktop/SaltmarshC/reports/01_litsearchr/alongi_2020", #absolute path
...
ccrcn_refs  <- 
    import_results(
    directory = "/home/lukas/Desktop/SaltmarshC/reports/01_litsearchr/CCRCN", #absolute path
    verbose = TRUE
  )
```
