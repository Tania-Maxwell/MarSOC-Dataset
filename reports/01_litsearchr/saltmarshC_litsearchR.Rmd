...
This document tracks the literature search used to acquire the global database of soil C in tidal salt marshes. 
...
# from the Youtube video - doesn't work
# titles_abstracts <- paste(BBWO_data$title, BBWO_data$abstract, collapse = "; ")
# 
# raked_keywords <- 
#   extract_terms(
...
Note: should we include river delta (# 34) and river estuary (# 35)?

```{r}
grouped_terms <-list(
  carbon_related = reduced_keywords[c(3:10, 30, 31, 40:43, 58:60 )],
  marsh_related =reduced_keywords[c(14:19, 36, 37, 48:52, 55, 61, 65, 66)]
)
...
We need to reduce the keywords, I think mostly those with habitat. 

I tried the search string in Scopus and it comes out with over 4,000 hits, compared to the original 259 in the first naive search. 
