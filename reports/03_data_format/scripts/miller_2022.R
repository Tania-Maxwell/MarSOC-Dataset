...
input_file01 <- "reports/03_data_format/data/core_level/Miller_2022_Marine_Scotland/Physical_geochemical_properties_narrow_cores.csv"
...
input_file02 <- "reports/03_data_format/data/core_level/Miller_2022_Marine_Scotland/Physical_geochemical_properties_wide_cores.csv"
